...
% Database representation of issues.

% To ensure that the task markdown is correctly parsed, they need to follow a standard format.
% To be correctly parsed the first line will be prefixed with the "# " character sequence, followed by the actual title.
